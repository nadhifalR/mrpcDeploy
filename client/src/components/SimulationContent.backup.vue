<template>
    <div class="simulasi-container grid col-auto p-0 m-0">
        ...
        <div class="simulasi-container-horizontal text-xs lg:text-xl">
            ...
            <div class="komp-selection">
                <label for="motherboard"></label>
                    <select v-model="motherboardSelect" id="motherboard" name="motherboard" class="form-control" tabindex="12">
                        <option value="" selected disabled hidden>Choose Motherboard</option>
                        <option v-for="motherboard in motherboards" :key="motherboard.id">
        ...
        <div class="simulasi-container-horizontal text-xs lg:text-xl">
            ...
            <div class="komp-selection">
                <label for="memory"></label>
                    <select v-model="memorySelect" id="memory" name="memory" class="form-control" tabindex="12">
                        <option value="" selected disabled hidden>Choose Memory</option>
                        <option v-for="memory in memorys" :key="memory.id">
        ...
        <div class="simulasi-container-horizontal text-xs lg:text-xl">
            ...
            <div class="komp-selection">
                <label for="graphicsCard"></label>
                    <select v-model="video_cardSelect" id="graphicsCard" name="graphicsCard" class="form-control" tabindex="12">
                        <option value="" selected disabled hidden>Choose Graphics Card</option>
                        <option v-for="video_card in video_cards" :key="video_card.id">
        ...
        <div class="simulasi-container-horizontal text-xs lg:text-xl">
            ...
            <div class="komp-selection">
                <label for="powerSupply"></label>
                    <select v-model="power_supplySelect" id="powerSupply" name="powerSupply" class="form-control" tabindex="12">
                        <option value="" selected disabled hidden>Choose Power Supply</option>
                        <option v-for="power_supply in power_supplys" :key="power_supply.id">
        ...
        <div class="simulasi-container-horizontal text-xs lg:text-xl">
            ...
            <div class="komp-selection">
                <label for="case"></label>
                    <select v-model="caseSelect" id="case" name="case" class="form-control" tabindex="12">
                        <option value="" selected disabled hidden>Choose Case</option>
                        <option v-for="i in cases" :key="i.id">
        ...
        <div class="simulasi-container-horizontal text-xs lg:text-xl">
            ...
            <div class="komp-selection">
                <label for="hardDrive"></label>
                    <select v-model="internal_hard_driveSelect" id="hardDrive" name="hardDrive" class="form-control" tabindex="12">
                        <option value="" selected disabled hidden>Choose Hard Drive</option>
                        <option v-for="internal_hard_drive in internal_hard_drives" :key="internal_hard_drive.id">
        ...
        <div class="simulasi-container-horizontal text-xs lg:text-xl">
            ...
            <div class="komp-selection">
                <label for="keyboard"></label>
                    <select v-model="keyboardSelect" id="keyboard" name="keyboard" class="form-control" tabindex="12">
                        <option value="" selected disabled hidden>Choose Keyboard</option>
                        <option v-for="keyboard in keyboards" :key="keyboard.id">
        ...
        <div class="simulasi-container-horizontal text-xs lg:text-xl">
            ...
            <div class="komp-selection">
                <label for="mouse"></label>
                    <select v-model="mouseSelect" id="mouse" name="mouse" class="form-control" tabindex="12">
                        <option value="" selected disabled hidden>Choose Mouse</option>
                        <option v-for="mouse in mouses" :key="mouse.id">
        ...
        <div class="simulasi-container-horizontal text-xs lg:text-xl">
            ...
            <div class="komp-selection">
                <label for="monitor"></label>
                    <select v-model="monitorSelect" id="monitor" name="monitor" class="form-control" tabindex="12">
                        <option value="" selected disabled hidden>Choose Monitor</option>
                        <option v-for="monitor in monitors" :key="monitor.id">
        ...
        <div class="simulasi-container-horizontal text-xs lg:text-xl">
            ...
            <div class="komp-selection">
                <label for="cpu_cooler"></label>
                    <select v-model="cpu_coolerSelect" id="cpu_cooler" name="cpu_cooler" class="form-control" tabindex="12">
                        <option value="" selected disabled hidden>Choose CPU Cooler</option>
                        <option v-for="cpu_cooler in cpu_coolers" :key="cpu_cooler.id">
        ...
        <div class="simulasi-container-horizontal text-xs lg:text-xl">
            ...
            <div class="komp-selection">
                <label for="caseFan"></label>
                    <select v-model="case_fanSelect" id="caseFan" name="caseFan" class="form-control" tabindex="12">
                        <option value="" selected disabled hidden>Choose Case Fan</option>
                        <option v-for="case_fan in case_fans" :key="case_fan.id">
        ...
        <div class="simulasi-container-horizontal text-xs lg:text-xl">
            ...
            <div class="komp-selection">
                <label for="wireless_network_card"></label>
                    <select v-model="wireless_network_cardSelect" id="wireless_network_card" name="wireless_network_card" class="form-control" tabindex="12">
                        <option value="" selected disabled hidden>Choose Wireless Network Card</option>
                        <option v-for="wireless_network_card in wireless_network_cards" :key="wireless_network_card.id">
        ...
        <div class="simulasi-container-horizontal text-xs lg:text-xl">
            ...
            <div class="komp-selection">
                <label for="wired_network_card"></label>
                    <select v-model="wired_network_cardSelect" id="wired_network_card" name="wired_network_card" class="form-control" tabindex="12">
                        <option value="" selected disabled hidden>Choose Wired Network Card</option>
                        <option v-for="wired_network_card in wired_network_cards" :key="wired_network_card.id">
        ...
        <div class="simulasi-container-horizontal text-xs lg:text-xl">
            ...
            <div class="komp-selection">
                <label for="optical_drive"></label>
                    <select v-model="optical_driveSelect" id="optical_drive" name="optical_drive" class="form-control" tabindex="12">
                        <option value="" selected disabled hidden>Choose Optical Drive</option>
                        <option v-for="optical_drive in optical_drives" :key="optical_drive.id">
        ...
        <div class="simulasi-container-horizontal text-xs lg:text-xl">
            ...
            <div class="komp-selection">
                <label for="sound_card"></label>
                    <select v-model="sound_cardSelect" id="sound_card" name="sound_card" class="form-control" tabindex="12">
                        <option value="" selected disabled hidden>Choose Sound Card</option>
                        <option v-for="sound_card in sound_cards" :key="sound_card.id">
        ...
        <div class="simulasi-container-horizontal text-xs lg:text-xl">
            ...
            <div class="komp-selection">
                <label for="speakers"></label>
                    <select v-model="speakersSelect" id="speakers" name="speakers" class="form-control" tabindex="12">
                        <option value="" selected disabled hidden>Choose Speakers</option>
                        <option v-for="speakers in speakerss" :key="speakers.id">
        ...
        <div class="simulasi-container-horizontal text-xs lg:text-xl">
            ...
            <div class="komp-selection">
                <label for="headphones"></label>
                    <select v-model="headphonesSelect" id="headphones" name="headphones" class="form-control" tabindex="12">
                        <option value="" selected disabled hidden>Choose Headphones</option>
                        <option v-for="headphones in headphoness" :key="headphones.id">
        ...
        <div class="simulasi-container-horizontal text-xs lg:text-xl">
            ...
            <div class="komp-selection">
                <label for="ups"></label>
                    <select v-model="upsSelect" id="ups" name="ups" class="form-control" tabindex="12">
                        <option value="" selected disabled hidden>Choose UPS</option>
                        <option v-for="ups in upss" :key="ups.id">
        ...
        <div class="simulasi-container-horizontal text-xs lg:text-xl">
            ...
            <div class="komp-selection">
                <label for="thermal_paste"></label>
                    <select v-model="thermal_pasteSelect" id="thermal_paste" name="thermal_paste" class="form-control" tabindex="12">
                        <option value="" selected disabled hidden>Choose Thermal Paste</option>
                        <option v-for="thermal_paste in thermal_pastes" :key="thermal_paste.id">
